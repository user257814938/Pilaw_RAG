export function BillingSettings() {
    return (
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
                <div className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">Free Plan</div>
                <div className="text-sm text-zinc-500">You are currently on the free tier.</div>
            </div>
